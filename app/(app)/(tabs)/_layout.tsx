...
import { Alert, Button, SafeAreaView, TextInput, TouchableOpacity } from 'react-native'
...
export default function _layout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name='finances' options={{ title: 'Finances', tabBarIcon: ({ color }) => <Ionicons name='cash-outline' size={24} color={color} /> }} />
      <Tabs.Screen
        name='create-link'
        options={{
          title: 'Create',
      ...
      />
      <Tabs.Screen name='events' options={{ title: 'Events', tabBarIcon: ({ color }) => <MaterialCommunityIcons name='party-popper' size={24} color={color} /> }} />
      <Tabs.Screen name='chores' options={{ title: 'Chores', tabBarIcon: ({ color }) => <FontAwesome6 name='person-digging' size={24} color={color} /> }} />
    </Tabs>
  )
}
